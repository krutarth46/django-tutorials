""" Added model structure for user creation  """
...
class UserProfile(TimeStampedModel,ActivatorModel,models.Model):
    ...
    telephone = models.CharField(verbose_name="Contact telephone number", max_length=255,
    ...
    country = models.CharField(verbose_name="Country",max_length=100, null=True, blank=True,
                                choices=COUNTRIES) # Selection added from countries fetched
